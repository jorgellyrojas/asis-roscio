...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('enc.png', 0, 0, 211); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(56, 10, utf8_decode('USUARIO'), 1, 1, 'C', 1);
...
while ($datos_reporte = $consulta_reporte_usuario->fetch_object()) {    
   ...
   $pdf->Cell(56, 10, utf8_decode($datos_reporte->usuario), 1, 1, 'C', 0);

   }


$pdf->Output('ReporteDeUsuarios.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
